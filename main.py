...
def train(cfg: DictConfig):
    ...
    experiment_name = f"{cfg.model.model.namee}_{cfg.experiment.dataset_name}_{cfg.data.task_type}_{cfg.optimizer.name}_{cfg.experiment.seed}_{cfg.experiment.id}"
    ...
    model = LightningModule(
        model_name=cfg.model.model.namee,
    ...
    print(f"Model:             {cfg.model.model.namee}")
